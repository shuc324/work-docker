<?php
/* SVN FILE: $Id: sanitize.php 6586 2011-05-09 05:25:23Z lightma $ */
/**
 ...
 * @lastmodified	$Date: 2011-05-09 13:25:23 +0800 (一, 2011-05-09) $
...
/**
 * Returns given array safe for display as HTML. Renders entities.
 *
 * @param array $array
 ...
 * @access public
 */	
	function htmlArray( &$array, $remove = false) {
		if ( is_array( $array ) ) {
			foreach ( $array as &$value ) {
				if ( is_array( $value ) ) {
					foreach( $value as &$sub_value ) {
						if ( $remove ) {
							$sub_value = strip_tags( $sub_value );
						} else {
							$patterns = array("/\&/", "/%/", "/</", "/>/", '/"/', "/'/", "/\(/", "/\)/", "/\+/", "/-/");
							$replacements = array("&amp;", "&#37;", "&lt;", "&gt;", "&quot;", "&#39;", "&#40;", "&#41;", "&#43;", "&#45;");
							$sub_value = preg_replace( $patterns, $replacements, $sub_value );
						}
					}
				}
				else {
			...
			$array = $this->html( $array, array('remove' => $remove) );
		}
	}
