...
class Log_file extends Log
{
                      ...
                      $level = PEAR_LOG_DEBUG)
    {
        ...
        if (!empty($conf['backtraceLevel'])) {
            $this->_backtraceLevel = $conf['backtraceLevel'];
        } else {
            $this->_backtraceLevel = 2;
        }
    ...
    function log($message, $priority = null)
    {
        ...
        $line = $this->_format($this->_lineFormat,
                               ...
                               $priority, $message,$this->_backtraceLevel) . $this->_eol;
