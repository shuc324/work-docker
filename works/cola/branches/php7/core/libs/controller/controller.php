<?php
/* SVN FILE: $Id: controller.php 7544 2011-07-06 08:24:59Z sparkwang $ */
/**
 ...
 */
	var $view = 'View';
/**
 * File extension for view templates. Defaults to Cola's conventional ".thtml".
 *
 * @var string
 * @access public
 */
 ...
 */
	function constructClasses() {
		...
		if (class_exists($this->modelClass) && ($this->uses === false)) {
			...
			return $this->colaError('missingModel', array(array('className' => $this->modelClass, 'webroot' => '', 'base' => $this->base)));
		}
		...
		if ($this->uses) {
			...
			foreach($uses as $modelClass) {
				...
				if (class_exists($modelClass)) {
					...
					return $this->colaError('missingModel', array(array('className' => $modelClass, 'webroot' => '', 'base' => $this->base)));
				}
			}
			return true;
		}
 ...
 */
	function paginate($object = null, $scope = array(), $whitelist = array()) {
        ...
        $passed_args = $this->passedArgs ? $this->passedArgs : array();
