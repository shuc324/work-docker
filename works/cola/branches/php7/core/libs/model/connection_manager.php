<?php
/* SVN FILE: $Id: connection_manager.php 1462 2010-05-12 09:31:01Z sparkwang $ */
 ...
 * @since			ColaPHP(tm) v 0.10.x.1402
 ...
 */
	function enumConnectionObjects() {
		...
		if ($connections != null) {
			...
			$_this->colaError('missingConnection', array(array('className' => 'ConnectionManager')));
		}
	}
/**
 ...
 */
	function __destruct() {
		if (COLA_SESSION_SAVE == 'database' && function_exists('session_write_close')) {
			session_write_close();
		}
	}
}
