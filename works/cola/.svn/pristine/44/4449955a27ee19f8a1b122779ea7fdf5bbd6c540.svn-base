<?php
/* SVN FILE: $Id: paths.php 7526 2011-07-06 02:03:11Z sparkwang $ */
/**
 * Short description for file.
 *
 * In this file you set paths to different directories used by Cola.
 *
 ...
 */
define ('INFLECTIONS', COLA.'config'.DS.'inflections'.DS);
/**
 * Path to the libs directory.
 */
define ('LIBS', COLA.'libs'.DS);
/**
 ...
 */
define('SCRIPTS', COLA.'scripts'.DS);
/**
 ...
 * The purporse is to make it easy porting Pear libs into Cola
