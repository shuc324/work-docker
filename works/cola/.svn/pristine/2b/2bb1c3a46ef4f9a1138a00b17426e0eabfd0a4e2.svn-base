<?php
/* SVN FILE: $Id: dbo_mssql.php 3963 2006-11-25 14:01:03Z phpnut $ */
...
if (!defined('MSSQL_CONNECT_TIMEOUT')) {
	define('MSSQL_CONNECT_TIMEOUT', 5);
}
/**
 ...
 */
	function connect() {
        ...
        ini_set('mssql.connect_timeout', MSSQL_CONNECT_TIMEOUT);
		$os = env('OS');
